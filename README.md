[ОПІСМ_практична_01_бланк.md](https://github.com/user-attachments/files/32181096/_._01_.md)
# Практична робота № 1
...
| **А3; 5** | |
| **ocaml.org** | |
| **Windows** | *(Linux / macOS / Windows / Killercoda)* |
| **curl 7.79.1 (Windows) libcurl/7.79.1 Schannel** | *(вивід `curl --version`, перший рядок)* |
| **14.09.2026** | |
...
```
curl -v https://ocaml.org
```

**Вивід:**

```
C:\Users\CyberPc>curl -v https://ocaml.org
*   Trying 51.159.83.169:443...
* Connected to ocaml.org (51.159.83.169) port 443 (#0)
...
< Date: Mon, 14 Sep 2026 05:42:57 GMT
< Vary: Accept-Encoding
< X-Varnish: 468393857 467284028
< Age: 40
...
<html lang="en">
  <head id="htmx-head">
    ...
    <meta name="description" content="OCaml is a general-purpose, industrial-strength programming language with an emphasis on expressiveness and safety.">

    <meta name="twitter:title" content="Welcome to a World of OCaml">

    <meta name="twitter:description" content="OCaml is a general-purpose, industrial-strength programming language with an emphasis on expressiveness and safety.">

    <meta name="twitter:image" content="https://ocaml.org/_/MWIyY2ZmMWM5YzdkYWNmYWI4NGQ0MDBjOGFiZTYxOTg/ocaml_org_social_media.png">
    <meta property="og:site_name" content="OCaml">
    <meta property="og:type" content="object">
    <meta property="og:title" content="Welcome to a World of OCaml">

    <meta property="og:description" content="OCaml is a general-purpose, industrial-strength programming language with an emphasis on expressiveness and safety.">
    ...
    <link rel="canonical" href="https://ocaml.org">

    <link rel="icon" type="image/x-icon" href="/_/ZDJmMjgzN2NkZmJlMzgxNGQxMTMxNGVlMzk1NzZkN2I/favicon.ico">
    <link rel="manifest" href="/manifest.json">

    <link rel="stylesheet" href="/_/ZDFjMGMzM2U2NTk2OGY5YzBjOWU2YTZhMTdhNzNkMDk/css/main.css">
    ...
    <link rel="stylesheet" href="/_/YmM5NjJlN2E4YzVkMDBmMDQ2ODEwNTQyNTBkNzE2MmM/vendors/swiper-bundle.min.css">
    <link rel="alternate" type="application/rss+xml" title="OCaml Planet Feed" href="/planet.xml">
    <script src="/_/ZDJiMGNkNGMzMjBlYjNmZGUxNTMxOTAyNjA0MDU2N2Q/vendors/swiper-bundle.min.js"></script>

    <link rel="search" href="/opensearch.xml" type="application/opensearchdescription+xml" title="OCaml">
    <title>Welcome to a World of OCaml</title>
  </head>
...
<a class="flex py-2 px-2 mx-2 gap-4 hover:bg-primary_nav_block_hover_10 dark:hover:bg-dark-primary_nav_block_hover_10 font-normal rounded-md text-primary dark:text-dark-primary" href="/api">
  ...
  <path fill-rule="evenodd" d="M18.9419 5.29661C17.6473 4.69088 16.263 4.25066 14.8157 4C14.638 4.32134 14.4304 4.75355 14.2872 5.09738C12.7487 4.86601 11.2245 4.86601 9.7143 5.09738C9.57116 4.75355 9.3588 4.32134 9.17947 4C7.73067 4.25066 6.3448 4.6925 5.05016 5.29982C2.43887 9.24582 1.73099 13.0938 2.08493 16.8872C3.81688 18.1805 5.49534 18.9662 7.14548 19.4804C7.55291 18.9196 7.91628 18.3235 8.22931 17.6953C7.63313 17.4688 7.06211 17.1892 6.52256 16.8647C6.6657 16.7586 6.80571 16.6478 6.94098 16.5337C10.2318 18.0729 13.8074 18.0729 17.0589 16.5337C17.1958 16.6478 17.3358 16.7586 17.4774 16.8647C16.9362 17.1908 16.3637 17.4704 15.7675 17.697C16.0805 18.3235 16.4423 18.9212 16.8513 19.4819C18.503 18.9678 20.183 18.1822 21.915 16.8872C22.3303 12.4897 21.2056 8.67705 18.9419 5.29661ZM8.67765 14.5543C7.68977 14.5543 6.87963 13.632 6.87963 12.509C6.87963 11.3859 7.67247 10.4621 8.67765 10.4621C9.68285 10.4621 10.493 11.3843 10.4757 12.509C10.4772 13.632 9.68285 14.5543 8.67765 14.5543ZM15.3223 14.5543C14.3344 14.5543 13.5243 13.632 13.5243 12.509C13.5243 11.3859 14.3171 10.4621 15.3223 10.4621C16.3275 10.4621 17.1376 11.3843 17.1203 12.509C17.1203 13.632 16.3275 14.5543 15.3223 14.5543Z" clip-rule="evenodd" />
          ...
          <a aria-label="The OCaml Compiler on GitHub" href="https://github.com/ocaml/ocaml" class="opacity-60 hover:opacity-100 text-content dark:text-dark-title hover:text-primary dark:hover:text-dark-primary">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  <path fill-rule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.* schannel: failed to decrypt data, need more data
004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clip-rule="evenodd" />
</svg>
...
<script>
  window.addEventListener('keydown', function(event) {
    ...
    <main class="bg-background dark:bg-dark-background"><div class="lg:py-24 py-2">
    ...
    <div class="flex flex-col lg:flex-row gap-6">
      <div class="lg:flex-1 lg:mt-16 my-12">
        ...
        <div class="space-x-0 lg:space-x-6">
          <a class="btn btn-lg mb-4 lg:mb-0" href="/install">Install</a>
          <a class="btn btn-lg btn-ghost" href="/about">
            About OCaml
          </a>
        </div>
        <div class="mt-6">
          <a class="text-2xl text-primary dark:text-dark-primary font-semibold" href="/releases/5.5.0">Latest release: 5.5.0</a>
        </div>
        <div class="mt-2">
          <a class="text-2xl text-primary dark:text-dark-primary font-semibold" href="/releases/4.14.4">Long Term Support release: 4.14.4</a>
        </div>
      </div>
...
<span aria-label="OCaml responds with"><i class="text-content dark:text-dark-content ">val square : int -&gt; int = &lt; fun &gt;</i></span>
...
<span><span class="text-blue-500  ml-4">if</span> x &lt;= 1 <span class="text-blue-500 ">then</span> 1 <span class="text-blue-500">else</span> x * factorial (x - 1)</span>
<span aria-label="OCaml responds with"><i class="text-content dark:text-dark-content">val factorial : int -&gt; int = &lt; fun &gt;</i></span>
...
<span aria-label="OCaml responds with"><i class="text-content dark:text-dark-content">- : int = 14400</i></span></code>
          ...
          <div class="flex-1 flex py-2 px-6 text-white text-opacity-50">
            <a
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="h-5 w-5 mr-2">
...
<div class="py-8 md:py-12 py-2 bg-acm-award">
  <div class="container-fluid space-y-24 lg:space-y-32">
    <div class="text-center md:text-left flex flex-col md:flex-row gap-6">
      <div class="md:w-60">
        <img class="mx-auto w-40" src="/_/NDBkZDQ2N2U3Y2VmM2I1NWZkNTk0NWJjOTNjNGYyYmE/img/acm_award_banner/acm_award_cup.svg" alt="illustration of a cup">
      </div>
      <div class="space-y-6">
        ...
        <a class="btn btn-md" href="/news/sigplan_announcement">Read more</a>
        <div class="hidden md:block md:flex-grow">
          <img class="ml-auto" src="/_/MWI2MzIxNGY1MGU1YjI5YWEzMzE5N2NkZjYxOTk2OWE/img/acm_award_banner/acm_logo.png" alt="illustration of a cup">
        </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid space-y-24 lg:space-y-32">
    <div class="text-center">
      ...
      <div class="text-content dark:text-dark-content text-base mt-3">
        These companies and organisations rely on OCaml every day — along with thousands of other developers. See <a href="/industrial-users" class="text-primary dark:text-dark-primary">Success Stories</a>
      </div>
      <div class="flex flex-row justify-center m-auto flex-wrap py-8 items-center">
          <div class="mx-8 my-4 dark:bg-dark-white py-4 px-12 rounded-md">
              <img class="h-8" src="/_/OGI2M2JmY2NkYzQ0NzNjNTRhNGQ3ZDhiZTQyMjhjNTY/logos/facebook.svg" alt="Facebook">
          </div>
          <div class="mx-8 my-4 dark:bg-dark-white py-4 px-12 rounded-md">
              <img class="h-8" src="/_/ODdlNDViNTBkNGY4YjFiNzBkY2E2ZTA5OTQwMmJiMWY/logos/microsoft.svg" alt="Microsoft">
          </div>
          <div class="mx-8 my-4 dark:bg-dark-white py-4 px-12 rounded-md">
              <img class="h-8" src="/_/OGNjZjBhMjg4MjQ2NDlmMWNiODE0ZGJjYjM5YzhiMmU/logos/docker.svg" alt="Docker">
          </div>
          <div class="mx-8 my-4 dark:bg-dark-white py-4 px-12 rounded-md">
              <img class="h-8" src="/_/Mzc0OTY1YzIzYWI2YmJkMzVlNGUzNThiNDM0ZGRlNDI/logos/janestreet.svg" alt="Jane Street">
          </div>
          <div class="mx-8 my-4 dark:bg-dark-white py-4 px-12 rounded-md">
              <img class="h-8" src="/_/ZGJiYTQ0NTA0MjQyMDIzMGU2YTJjZDFiNDAxY2E5YjA/logos/bloomberg.svg" alt="Bloomberg">
          </div>
          <div class="mx-8 my-4 dark:bg-dark-white py-4 px-12 rounded-md">
              <img class="h-8" src="/_/ZGVjYTI0ZGJjNzYzZmRlZGQ3OWI0MjgxYTUyZGFmZjU/logos/tezos.svg" alt="Tezos">
          </div>
          <div class="mx-8 my-4 dark:bg-dark-white py-4 px-12 rounded-md">
              <img class="h-8" src="/_/MjcxNDQ0ZThiMDY2NjA0Y2ExNWRmZTRiOTQ2Y2M5ZWQ/logos/ahrefs.svg" alt="Ahrefs">
          </div>
      </div>
    </div>
  </div>
...
<div class="bg-background dark:bg-dark-background">
        ...
        <div class="lg:flex-1 mt-10 lg:mt-0">
          <div class="text-base">
            <div class="h-12 w-12 text-white rounded-xl flex bg-gradient-to-br from-blue-400 to-blue-600">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 m-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
        ...
        <div class="lg:flex-1 lg:mt-0 mt-10 flex justify-center">
          <img src="/_/ZTM4NWExMjJiZjAwZjEzMWY5MTNjYjZiZjNhNTFiODc/img/home/safe-stable.svg" alt="An example OCaml program defining nested lists in OCaml. A terminal output also shows the compiler catching a type error where a pattern-match was not exhaustive.">
        </div>
      </div>
          ...
          <div style="--swiper-navigation-color: #fff;--swiper-pagination-color: #fff;" class="swiper mySwiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div>
                  <img src="/_/YTgwYjYyMzhlYzQwNTRhNmRlMzJkNTZmMDk3YWM2NTY/logos/vscode.svg" width="56" alt="VS Code">
                  <img src="/_/YzA5ZWY4OTQ5Mjc1NjA4MmQ3NzAyNThmMWJmZmZlZTE/img/home/vscode-preview.png" alt="">
                </div>
              </div>
              <div class="swiper-slide">
                <div>
                <img src="/_/MzEyZWI2NmFiMWY4ZGEwZmRkMDcxYTgzNzU5NjM5NzA/logos/vim.svg" width="56" alt="Vim">
                <img src="/_/ZDkzZDYxMDlmMmZjMTdhNjdhNTBhMTg4MTE1ZjFjMGI/img/home/vim-preview.png" alt="">
                </div>
              </div>
              <div class="swiper-slide">
                <div>
                <img src="/_/NjBkMWJkNDgzZjAwMTQ4MjlmYjUyN2Q1ZDMwZDAxMzk/logos/emacs.svg" width="56" alt="Emacs">
                <img src="/_/YjEyNTk1YjM2ZmIyMWFlNGFlYTM2MTAxYWQ1NDU1Yzg/img/home/emac-preview.png" alt="">
                </div>
              </div>
            </div>
          </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
        ...
        <div class="lg:flex-1 lg:mt-0 mt-10 flex justify-center">
          <img src="/_/ZWVmZmU2MzczN2FjZTk2OGE5MDViNTdmMmNmNmQwMTA/img/home/workfaster.svg" alt="">
        </div>
      </div>
    </div>
  </div>
...
<div class="py-24 overflow-hidden">
  <div class="container-fluid">
    <div class="prose dark:prose-invert mx-auto">
        ...
        -- S* schannel: failed to decrypt data, need more data
* schannel: failed to decrypt data, need more data
cott, D. & Sharp, R. & Gazagnaire, T. & Madhavapeddy, A. (2010).
  ...
  <div class="container-fluid grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch mb-14">
      <div class="flex flex-col">
        ...
        <div class="text-primary dark:text-dark-primary text-sm mb-4 uppercase">Recent Releases</div>
          ...
          <div class="mb-4">
          <a href="/releases/5.5.0">
            <h3 class="font-bold mb-6 text-title dark:text-dark-title hover:underline">
              5.5.0 <span class="text-sm">(2026-06-19)</span>
            </h3>
          </a>
          <div class="prose dark:prose-invert prose-sm"><ul>
<li>Module-dependent functions</li>
<li>Polymorphic functions as function arguments</li>
<li>Relocatable compiler</li>
<li>Generalized local definitions</li>
<li>Search and replace substring functions</li>
<li>External types</li>
<li>Garbage collector improvements</li>
<li>Around 60 new functions in the standard library</li>
</ul>
</div>
           </div>

          <div class="mb-4">
          <a href="/releases/5.4.1">
            <h3 class="font-bold mb-6 text-title dark:text-dark-title hover:underline">
              5.4.1 <span class="text-sm">(2026-02-17)</span>
            </h3>
          </a>
          <div class="prose dark:prose-invert prose-sm"><ul>
<li>Security hardening of the Marshal module (<a href="https://osv.dev/vulnerability/OSEC-2026-01">OSEC-2026-01</a>)</li>
<li>Fix for <code>-pack</code> mode on macOS</li>
<li>Fix for miscompilation of string operations</li>
<li>Several ThreadSanitizer (TSan) fixes</li>
</ul>
</div>
           </div>


          <a href="/releases" class="btn btn-ghost rounded mt-8">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
            ...
            <a href="/changelog/2026-07-21-dune3241" class="my-0 font-sans text-xl tracking-normal font-extrabold leading-7 changelog-title whitespace-normal break-all text-title dark:text-dark-title hover:underline">Dune 3.24.1</a>
            <time datetime="2026-07-21" class="block mt-1 font-sans text-sm text-content dark:text-dark-content">21 Jul 2026</time>
        </div>
        <p class="prose dark:prose-invert prose-orange">

The Dune team is pleased to announce [the release of dune
3.24.1](https://github.com/ocaml/dune/rel...
        </p>
        <a href="/changelog" class="text-primary dark:text-dark-primary mt-2 hover:underline">
          See full changelog
        </a>
    </div>
  </div>
...
<div class="pl-8 border-l-2 border-separator_20 dark:border-dark-separator_30">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
            ...
            <a href="/changelog/2026-07-09-opam-2-5-2" class="my-0 font-sans text-xl tracking-normal font-extrabold leading-7 changelog-title whitespace-normal break-all text-title dark:text-dark-title hover:underline">opam 2.5.2</a>
            <time datetime="2026-07-09" class="block mt-1 font-sans text-sm text-content dark:text-dark-content">09 Jul 2026</time>
        </div>
        <p class="prose dark:prose-invert prose-orange">
...
<div class="pl-8 border-l-2 border-separator_20 dark:border-dark-separator_30">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
            ...
            <a href="/changelog/2026-06-30-dune3240" class="my-0 font-sans text-xl tracking-normal font-extrabold leading-7 changelog-title whitespace-normal break-all text-title dark:text-dark-title hover:underline">Dune 3.24.0</a>
            <time datetime="2026-06-30" class="block mt-1 font-sans text-sm text-content dark:text-dark-content">30 Jun 2026</time>
        </div>
        <p class="prose dark:prose-invert prose-orange">

The Dune team is pleased to announce [the release of dune
3.24.0](https://github.com/ocaml/dune/rel...
        </p>
        <a href="/changelog" class="text-primary dark:text-dark-primary mt-2 hover:underline">
          See full changelog
        </a>
            ...
            <a href="/changelog" class="btn btn-ghost rounded mt-8">
    ...
    <div class="flex flex-col lg:flex-row justify-between lg:space-x-20 space-y-10 lg:space-y-0">
      <div class="shadow-lg p-10 bg-white rounded-2xl border dark:bg-dark-card">
        ...
        <div>
          ...
          <a class="btn mt-10 py-8" href="/academic-users">Learn more</a>
        </div>
      </div>
      <div class="shadow-lg p-10 bg-white rounded-2xl border dark:bg-dark-card">
        <div class="flex flex-row items-center justify-between relative pb-8">
        ...
        <div>
          ...
          <a class="btn mt-10 py-8" href="/industrial-users">Learn more</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="intro-section-simple dark:dark-intro-section-simple lg:py-32 py-24">
  <div class="container-fluid">
    <div class="">
      ...
      <div class="grid lg:grid-cols-3 gap-8 lg:gap-16">
        <a href="/install" class="card dark:dark-card p-4 text-title dark:text-dark-title">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        <a href="/manual" class="card dark:dark-card p-4 text-title dark:text-dark-title">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        ...
        <a href="/books" class="card dark:dark-card p-4 text-title dark:text-dark-title">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path d="M2.46875 15.1935L2.5293 4.46692H1.31836V18.1154C2.98242 17.6857 4.65234 17.4122 6.33398 17.4005C7.88672 17.3908 9.43945 17.6075 10.9961 18.1349C10.0293 17.3517 8.95117 16.7755 7.80078 16.4005C6.35156 15.9279 4.78516 15.7716 3.17969 15.9083C2.81641 15.9376 2.5 15.6681 2.46875 15.3068C2.46484 15.2677 2.46484 15.2306 2.46875 15.1935ZM20.2383 3.90638C20.2344 3.87513 20.2305 3.84192 20.2305 3.80677C20.2305 3.77356 20.2324 3.74036 20.2383 3.70716V1.53528C18.7148 1.39075 17.1445 1.55872 15.7734 2.07825C14.4922 2.56458 13.3867 3.36341 12.668 4.50794V16.879C13.7852 16.1329 14.9277 15.5197 16.1016 15.1017C17.4395 14.6251 18.8145 14.3986 20.2383 14.5118V3.90638ZM21.5566 3.14856H23.3418C23.7051 3.14856 24 3.44349 24 3.80677V18.9747C24 19.338 23.7051 19.6329 23.3418 19.6329C23.2676 19.6329 23.1953 19.6212 23.1289 19.5978C21.293 19.0724 19.4688 18.7228 17.6621 18.7111C15.9004 18.6993 14.1406 19.0099 12.373 19.7892C12.2637 19.8615 12.1328 19.9005 11.998 19.8986C11.8652 19.9005 11.7344 19.8615 11.623 19.7892C9.85742 19.0079 8.0957 18.6993 6.33398 18.7111C4.52734 18.7228 2.70508 19.0724 0.867188 19.5978C0.800781 19.6212 0.728516 19.6329 0.654297 19.6329C0.294922 19.6349 0 19.34 0 18.9767V3.80677C0 3.44349 0.294922 3.14856 0.658203 3.14856H2.53516L2.54688 0.949345C2.54883 0.632939 2.77148 0.37122 3.07031 0.30872C4.80273 -0.0526083 6.9082 0.0372355 8.75391 0.744267C10.0293 1.23255 11.1875 2.01184 12.0332 3.13685C12.8867 2.08802 14.0273 1.33411 15.3105 0.847782C17.0645 0.181767 19.0879 0.0216105 20.9922 0.300907C21.3203 0.347782 21.5547 0.630986 21.5547 0.951298V3.14856H21.5566ZM13.3066 18.0353C14.7617 17.5783 16.2148 17.3908 17.668 17.3986C19.3496 17.4083 21.0195 17.6837 22.6836 18.1134V4.46692H21.5566V15.2521C21.5566 15.6154 21.2617 15.9103 20.8984 15.9103C20.8457 15.9103 20.7949 15.9044 20.7461 15.8927C19.3047 15.6661 17.9082 15.8536 16.5449 16.34C15.4473 16.7325 14.3691 17.3185 13.3066 18.0353ZM11.3516 16.7521V4.48841C10.6621 3.27161 9.54688 2.45716 8.28711 1.97474C6.85938 1.42786 5.25586 1.30481 3.85742 1.50403L3.7832 14.5529C5.30859 14.4982 6.80078 14.6915 8.20508 15.1505C9.32227 15.5138 10.3809 16.047 11.3516 16.7521Z" fill="currentColor"/>
        ...
        <a href="/api" class="card dark:dark-card p-4 text-title dark:text-dark-title">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
        ...
        <a href="/exercises" class="card dark:dark-card p-4 text-title dark:text-dark-title">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11.5V14m0-2.5v-6a1.5 1.5 0 113 0m-3 6a1.5 1.5 0 00-3 0v2a7.5 7.5 0 0015 0v-5a1.5 1.5 0 00-3 0m-6-3V11m0-5.5v-1a1.5 1.5 0 013 0v1m0 0V11m0-5.5a1.5 1.5 0 013 0v3m0 0V11" />
        ...
        <a href="/papers" class="card dark:dark-card p-4 text-title dark:text-dark-title">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mb-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
<div class="bg-background dark:bg-dark-background py-20 overflow-hidden">
  <div class="container-fluid">
    <div class="grid grid-cols-1 lg:grid-cols-2 items-center">
      <div class="space-y-8">
        <div class="space-y-6">
          <h2 class="font-bold text-title dark:text-dark* schannel: failed to decrypt data, need more data
* schannel: failed to decrypt data, need more data
-title">OCaml Packages</h2>
          <p class="text-lg text-content dark:text-dark-content">
            Explore thousands of open-source OCaml packages with their
            documentation.
          </p>
        </div>
        <a href="/packages" class="btn btn-lg mt-8 flex items-center">
...
* Connection #0 to host ocaml.org left intact
```
...
```
curl -v http://ocaml.org
```

**Вивід:**

```
C:\Users\CyberPc>curl -v http://ocaml.org
*   Trying 51.159.83.169:80...
* Connected to ocaml.org (51.159.83.169) port 80 (#0)
> GET / HTTP/1.1
> Host: ocaml.org
> User-Agent: curl/7.79.1
> Accept: */*
...
* Mark bundle as not supporting multiuse
< HTTP/1.1 301 Moved
< Date: Mon, 14 Sep 2026 05:47:51 GMT
< Server: Varnish
< X-Varnish: 466629706
< location: https://ocaml.org/
< Content-Length: 0
< Connection: keep-alive
<
* Connection #0 to host ocaml.org left intact
...
*Windows: `Resolve-DnsName ocaml.org`*
...
```
PS C:\Users\CyberPc> Resolve-DnsName ocaml.org
>>

Name                                           Type   TTL   Section    IPAddress
----                                           ----   ---   -------    ---------
ocaml.org                                      A      300   Answer     51.159.83.169
...
**C:\Users\CyberPc>dig ocaml.org
"dig" не является внутренней или внешней
...
Name                                           Type   TTL   Section    IPAddress
----                                           ----   ---   -------    ---------
ocaml.org                                      A      272   Answer     51.159.83.169
...
|---|---|---|
| Час виконання (год:хв) |20:25 |20:30 |
| IP-адреса |51.159.83.169 |51.159.83.169 |
| Значення TTL |300 | 272|
...
```
(C:\Users\CyberPc>curl -v https://google.com
*   Trying 142.251.98.101:443...
* Connected to google.com (142.251.98.101) port 443 (#0)
* schannel: disabled automatic use of client certificate
* schannel: ALPN, offering http/1.1
* schannel: ALPN, server accepted to use http/1.1
> GET / HTTP/1.1
...
< Content-Type: text/html; charset=UTF-8
< Content-Security-Policy-Report-Only: object-src 'none';base-uri 'self';script-src 'nonce-RrSHbDOHw_eTU5B8OJM5bg' 'strict-dynamic' 'report-sample' 'unsafe-eval' 'unsafe-inline' https: http:;report-uri https://csp.withgoogle.com/csp/gws/other-hp
< Date: Mon, 14 Sep 2026 05:55:14 GMT
< Expires: Wed, 14 Oct 2026 05:55:14 GMT
...
```
C:\Users\CyberPc>curl -v https://expired.badssl.com
...
C:\Users\CyberPc>curl -v https://wrong.host.badssl.com
*   Trying 104.154.89.105:443...
...
```
C:\Users\CyberPc>curl -v https://self-signed.badssl.com
*   Trying 104.154.89.105:443...
...
|---|---|---|---|
| 1 |DNS-запити |А3 |Відображає спробу виконання DNS-запиту для визначення IP-адреси доменного імені ocaml.org, яка завершилася помилкою. |
| 2 |Запит curl -v та захищеність підключення|A1 |schannel: failed to decrypt data, need more data — діагностичне повідомлення Windows Schannel. Незважаючи на нього, сервер успішно відповів HTTP/1.1 200 OK. Підключення здійснено через HTTPS/TLS. |
| 3 |curl -v http://ocaml.org — запит без захисту з'єднання |A2 |Встановлено незахищене HTTP-з'єднання через порт 80. Сервер повернув HTTP/1.1 301 Moved та перенаправив запит на захищену версію https://ocaml.org/. Шифрування TLS на цьому етапі не використовується. |
| 4 | | | |
| 5 | | | |
| 6 | | | |
| 7 | | | |
...
> У А.1 є діагностичні рядки schannel, пов’язані із захищеним TLS-з’єднанням. В А.2 вони відсутні, оскільки використовується незахищений HTTP через порт 80. Сервер повертає 301 Moved і перенаправляє на HTTPS.

**3. Звідки у виводі з'явилося значення `443`, якщо його не було вказано в адресі?**

> Порт 443 є стандартним портом для протоколу HTTPS. Оскільки в адресі https://ocaml.org порт явно не вказаний, curl автоматично використовує стандартний порт HTTPS — 443.

**4. Як змінилося значення TTL між двома запитами (A.3)? Що означає це число?**

> з TLL: 300 до 272 TTL: . TTL - максимальний період часу або кількість ітерацій або переходів, за який набір даних (пакет) може існувати до свого зникнення.
...
|---|---|
| `expired` |сертифікат не дійсний |
| `wrong.host` |сертифікат від іншого хоста |
...
|---|---|---|
| 1 |< Content-Type: text/html; charset=utf-8 |А1 |
| 2 |  Connection: keep-alive| А1|
| 3 |Accept-Ranges: bytes |А1|
...
>  Неочікуваним для мене стало те, що після виконання команди curl -v https://ocaml.org у завданні А.1 я отримав не лише основні параметри з’єднання, а й багато додаткової інформації. Спочатку я очікував побачити тільки адресу сервера, статус підключення та результат виконання запиту. Однак у виводі з’явилися повідомлення про встановлення з’єднання, роботу Schannel, використання HTTPS, HTTP-заголовки та інші технічні параметри.

Також мене здивувало, що після службової інформації curl вивів безпосередньо вміст веб-сторінки у форматі HTML. У ньому були присутні різні елементи сторінки та частини скриптів. Я не очікував, що одна команда дозволить одночасно перевірити з’єднання та отримати фактичний код веб-сторінки.

Під час виконання HTTP-запиту я також помітив, що сервер перенаправляє його на HTTPS за допомогою коду 301 Moved. Це дозволило мені на практиці побачити різницю між HTTP та HTTPS.

**D.1. Що виявилося неочевидним або несподіваним**

*Назвати конкретно, з посиланням на рядок виводу.*

>  Неочікуваним для мене стало те, що після виконання команди curl -v https://ocaml.org у завданні А.1 я отримав не лише основні параметри з’єднання, а й багато додаткової інформації.

**D.2. Чому саме така кількість груп у частині B**

*У частині В, на мою думку, достатньо трьох груп, оскільки всі результати чітко розподіляються за категоріями. Створення додаткових груп не є необхідним.*
...
|---|---|---|---|
| 1 |Чому відхиляє запрос Resolve-DnsName ocaml.org в Powershell|GPT-5.6 Luna |https://chatgpt.com/share/6aa99063-7248-83eb-b379-aed6f66dd4d4 |
| 2 | | | |
| 3 | | | |
